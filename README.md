...
🧩 Smart Contract API
<details> <summary>📥 joinDAO()</summary>
...
Chain ID	1115
Currency	CORE
Explorer	scan.test2.btcs.network

Deployed Contract	0xFFBf...874bC
💻 Usage Examples
...
This project is under the MIT License — View License
